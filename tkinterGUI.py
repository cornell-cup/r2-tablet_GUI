...
class GUIapp():
    ...
    def __init__(self):
        ...
        c1 = Label(self.tab3, text="Voice Recognition Text", font=("Helvetica", 17))
        c2 = Label(self.tab3, text="Sentiment Analysis Output", font=("Helvetica", 17))
        c3 = Label(self.tab3, text="Facial Recognition Photo", font=("Helvetica", 17))
        c4 = Label(self.tab3, text="Facial Recognition Result", font=("Helvetica", 17))
        c5 = Label(self.tab3, text="Object Detection Result", font=("Helvetica", 17))
